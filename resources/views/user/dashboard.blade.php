                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2">
                                                        <div class="my-auto">
                                                            <h6 class="mb-0 text-sm">{{ $file->number }}</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <span class="text-xs font-weight-bold">{{ $file->plot_number }} </span>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                    <span class="me-2 text-xs font-weight-bold">{{ $file->category }}</span>
                                                    </div>
                                                </td>
                                                <td class="align-middle">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <span class="me-2 text-xs font-weight-bold">{{ $file->place_of_allocation }}</span>
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforeach
